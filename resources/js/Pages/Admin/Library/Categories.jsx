...
export default function Categories({ categories = [] }) {
    ...
    const del = (id) => {
        ...
        router.delete(route('admin.library.categories.destroy', id), { preserveScroll: true });
    };

    return (
        <AdminLayout title="Library Categories">
            <Head title="Admin - Library Categories" />
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                <div className="rounded-2xl border border-gray-200 bg-white p-5 lg:col-span-1">
                    ...
                    <div className="mt-1 text-xs text-gray-500">Organize books and notes.</div>
                    ...
                    <form onSubmit={submit} className="mt-4 space-y-4">
                        <div>
                            ...
                            />
                            {form.errors.name ? <div className="mt-1 text-xs font-bold text-rose-600">{form.errors.name}</div> : null}
                        </div>
