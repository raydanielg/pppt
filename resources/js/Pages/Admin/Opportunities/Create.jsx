...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('admin.opportunities.store'));
    };

    return (
        <AdminLayout title="Create Opportunity">
            <Head title="Admin - Create Opportunity" />
            ...
            <form onSubmit={submit} className="rounded-2xl border border-gray-200 bg-white p-5">
                <div className="flex items-center justify-between gap-3">
                    <div>
                        <div className="text-sm font-black text-gray-900">New Vacancy</div>
                        <div className="text-xs text-gray-500">Create an opportunity that appears on public Opportunities page.</div>
                    </div>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                    <div className="md:col-span-2">
                        ...
                        <input
                            ...
                            placeholder="e.g. PHYSIOTHERAPIST II"
                        />
