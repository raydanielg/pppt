...
export default function Categories({ categories = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('admin.health-tip-categories.store'), {
            preserveScroll: true,
    ...
    const del = (id) => {
        if (!confirm('Delete this category? Tips inside will also be deleted.')) return;
        router.delete(route('admin.health-tip-categories.destroy', id), { preserveScroll: true });
    };

    return (
        <AdminLayout title="Health Tip Categories">
            <Head title="Admin - Health Tip Categories" />
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                <div className="rounded-2xl border border-gray-200 bg-white p-5 lg:col-span-1">
                    ...
                    <div className="mt-1 text-xs text-gray-500">Used to organize health tips.</div>
