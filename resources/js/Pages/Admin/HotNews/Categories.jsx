...
export default function Categories({ categories = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('admin.hot-news-categories.store'), {
            preserveScroll: true,
    ...
    const del = (id) => {
        if (!confirm('Delete this category? Existing news will keep the category name but this category entry will be removed.')) return;
        router.delete(route('admin.hot-news-categories.destroy', id), { preserveScroll: true });
    };

    return (
        <AdminLayout title="News Categories">
            <Head title="Admin - News Categories" />
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                <div className="rounded-2xl border border-gray-200 bg-white p-5 lg:col-span-1">
                    ...
                    <div className="mt-1 text-xs text-gray-500">Used to organize news posts.</div>
